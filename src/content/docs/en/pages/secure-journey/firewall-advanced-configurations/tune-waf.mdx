...
**Note:** WAF logs are retained for the last 3 days. For comprehensive information and better visualization of unified WAF logs, consider using the Edge Application data source.
</Fragment>
