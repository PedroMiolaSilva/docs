...
To activate Origin Shield, follow these steps:

- Ensure that the [Network Layer Protection module](/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/#modules) is enabled in your account.
- Subscribe to the Origin Shield add-on by contacting the [sales team](https://www.azion.com/en/contact-sales/).
- Once subscribed, access the Azion Console or Real-Time Manager to activate the feature. [TECHWRITER TODO: INSERT INFORMATION ABOUT HOW TO ACTIVATE ORIGIN SHIELD IN AZION CONSOLE/RTM]
