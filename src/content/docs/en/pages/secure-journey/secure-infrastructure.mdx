...
### Acquiring the Origin Shield
To acquire the Origin Shield, you need to follow these steps:
1. Ensure you have the necessary permissions on your Azion account.
2. Contact the [sales team](https://www.azion.com/en/contact-sales/) to express your interest in the Origin Shield add-on. 
3. Complete any required forms and provide necessary documentation as specified by the sales team.
4. Await confirmation and further instructions from Azion's support team.

[TECHWRITER TODO: INSERT INFORMATION ABOUT HOW TO DO THIS]