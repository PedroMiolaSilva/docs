...
1. Ensure you have the **Network Layer Protection module** enabled.
2. Subscribe to the **Origin Shield add-on** by contacting the [sales team](https://www.azion.com/en/contact-sales/).

Once activated, you will be able to access the list of IP addresses used by Origin Shield.
