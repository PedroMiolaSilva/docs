...
With this guide, you'll create a rule in the response phase to remove an HTTP header using the **Filter Response Header** behavior. Note that "Network Layer" is not a phase option when creating rules.
