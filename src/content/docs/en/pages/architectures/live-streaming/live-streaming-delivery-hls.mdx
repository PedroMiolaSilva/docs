...
4. Configure your source and encoder pointing to Azion Ingest DNS entries. Ensure that your encoder is correctly configured to output in HLS format. [TECHWRITER TODO: INSERT INFORMATION ABOUT HOW TO CONFIGURE ENCODER FOR HLS DELIVERY]
