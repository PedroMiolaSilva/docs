...
To deliver videos in MP4 using HLS format, consider using Azion Edge Storage. Edge Storage allows you to store video files closer to the user, minimizing latency and improving access times. [TECHWRITER TODO: INSERT INFORMATION ABOUT HOW TO CONFIGURE AZION EDGE STORAGE FOR MP4 DELIVERY]
