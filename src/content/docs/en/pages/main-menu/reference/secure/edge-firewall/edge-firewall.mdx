...
An edge firewall consists of an identification name, all your application domains where Edge Firewall should be applied, the applied modules, and the security rules configured in the **Rules Engine** tab.
...
:::note
You need to activate at least one module for the edge firewall to work.
:::
...
[TECHWRITER TODO: INSERT INFORMATION ABOUT HOW TO CONFIGURE NETWORK LAYER PROTECTION RULES]
