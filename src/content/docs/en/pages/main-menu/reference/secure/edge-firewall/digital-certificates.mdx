...
Before configuring TLS settings, ensure you have the necessary permissions to perform these actions. Only users with appropriate access rights can enable or modify TLS settings for domains. Confirm your permissions in the Azion Console or contact your system administrator to obtain the required access.
