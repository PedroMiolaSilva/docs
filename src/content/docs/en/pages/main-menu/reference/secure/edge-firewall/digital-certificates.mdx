...
Before configuring TLS settings on your domain, it is essential to ensure that you have the appropriate access rights. Configuring TLS may require administrative privileges or specific permissions within the Azion Console. It is recommended to verify these permissions with your system administrator or IT department. Attempting to configure TLS settings without the necessary permissions may lead to failures or incomplete configurations.
