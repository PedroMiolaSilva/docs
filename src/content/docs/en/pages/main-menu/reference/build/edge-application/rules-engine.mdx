...
#### Using LIKE in Real-Time Events and GraphQL

Azion allows the use of the 'LIKE' parameter as an alternative to regex when querying requests in Real-Time Events and GraphQL. This can be particularly useful for pattern matching within query operations.
...
| LIKE | The value of the variable matches the pattern using the LIKE operator, similar to SQL | string |
...
To enhance logging and identify rule execution, enable Debug Rules in the **Edge Application** and **Edge Firewall**. This will allow you to gain insights into rule processing and aid in troubleshooting.
