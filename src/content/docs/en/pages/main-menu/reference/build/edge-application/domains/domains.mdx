...
To enable HTTPS for your domain, ensure that you have a valid digital certificate associated with your domain. HTTPS operates over port **443** by default. 

Azion supports TLS versions starting from **1.1**. Ensure your configurations are compatible with the minimum supported TLS version.

[TECHWRITER TODO: INSERT INFORMATION ABOUT HOW TO ENABLE TLS FOR THE DOMAIN ferramentas.credipronto.com.br]
...
## Permissions and Configuration Changes

To make configuration changes to the domain settings, specific permission levels are required. Generally, administrative access is necessary to make changes, including enabling TLS and managing certificates.

[TECHWRITER TODO: INSERT DETAILED INFORMATION ABOUT PERMISSION LEVELS AND AUTHORIZED PERSONNEL]
