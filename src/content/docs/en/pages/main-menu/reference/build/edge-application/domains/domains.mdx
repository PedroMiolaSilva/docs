...
1. Log in to your [Azion Console](https://console.azion.com).
2. Navigate to the **Domains** section.
3. Click on **Add Custom Domain**.
4. Enter the necessary details, including your domain name.
5. Configure your DNS settings as required.
6. Click **Save** to finalize the process.

For more detailed guidance on adding a custom domain, refer to [this link](/en/documentation/products/getting-started/#step-3-adding-a-custom-domain).  
