...
1. Go to the [Azion Console](https://console.azion.com).
2. Navigate to the Domains section.
3. Click on "Add Custom Domain."  
4. Enter your domain name and select the appropriate settings.
5. Configure your DNS records according to the provided instructions.
6. Bind a Digital Certificate if necessary.
7. Save your changes and ensure the domain is successfully added.
