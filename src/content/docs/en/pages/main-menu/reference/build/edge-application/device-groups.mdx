...
To create and manage device groups, follow these steps:

1. Navigate to the Device Groups section within the Azion Console.
2. Click on the **Create Device Group** button.
3. Enter a name for your device group. It should be descriptive enough to indicate what devices will be included.
4. Define a regular expression that matches the `User-Agent` strings of the devices you want to include in this group. [TECHWRITER TODO: INSERT INFORMATION ABOUT HOW TO DEFINE A REGULAR EXPRESSION].
5. Save your device group.

Once created, you can manage your device groups by:
- Editing the name or regular expression of an existing group.
- Deleting a device group that is no longer needed.
- Viewing analytics related to the requests made by devices in each group. [TECHWRITER TODO: INSERT INFORMATION ABOUT VIEWING ANALYTICS].
