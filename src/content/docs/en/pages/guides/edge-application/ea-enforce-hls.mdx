...
Azion Edge Platform allows you to [deliver live streaming content in HLS format](https://www.azion.com/en/solutions/live-streaming-delivery/), being able to easily self-provision and configure your cache policies. This guide covers the step-by-step to enforce HLS cache, manage chunks and playlists caching, and set up rules engine rules.
...
- Use of [Azion Edge Storage](/en/documentation/products/edge-storage/) for storing and delivering video content.
...
In this example, an edge application and a domain linked to it have been previously created.
