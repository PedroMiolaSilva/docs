...
Azion provides a ready-made JSON script that you can use to create a Grafana dashboard with real-time metrics. Simply follow the instructions below to utilize the script:

1. Access the Grafana dashboard creation page.
2. Copy the JSON script provided in this documentation.
3. Paste it into the Grafana JSON editor.
4. Save and visualize the dashboard with Azion's real-time metrics.
