...
## Ready-made Script for Grafana Integration

Azion provides a ready-made JSON script that you can use to integrate and visualize data in Grafana dashboards. This JSON script is provided above in the "Data Transferred dashboard on Grafana JSON example" section. By using this script, you can easily set up a dashboard to monitor Data Transferred metrics from Azion's Real-Time Metrics, allowing you to gain insights into your edge applications effectively.