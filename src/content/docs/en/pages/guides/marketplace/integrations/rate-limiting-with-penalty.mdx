...
## Custom Function Development Responsibilities and Feature Request Procedures

### Developing Custom Functions

While Azion provides integrations like Upstash Rate Limiting, clients are responsible for developing any custom functions that may require unique logic or behavior beyond what is provided.

Clients should ensure they have the necessary technical expertise to implement and maintain these functions. Custom functions should be thoroughly tested in a staging environment before deploying to production to avoid service disruptions.

### Requesting New Features

If you find that a required feature is not available in the current integration, you can request new features by contacting Azion's product team through the customer support portal or via your account manager.

Please provide a detailed description of the feature, including use cases and potential impact on your operations. This information will help the product team to assess the feasibility and priority of the feature request.
